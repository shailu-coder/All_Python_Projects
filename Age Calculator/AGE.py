...
root.configure(bg="#30336b")   #setting up background color
root.geometry("400x300")    #fixing the size of the window
root.iconbitmap("age.ico") # set Icon
new=Label(root,bg="#30336b")  #declaring a label
...
title_label=Label(root,text="AGE CALCULATOR",borderwidth=10,fg="#fff",bg="#30336b")
title_label.config(font=("Arial Rounded MT Bold",29))
title_label.grid(row=0,column=0,columnspan=3)
label_date=Label(root,text="BIRTH DATE : ",borderwidth=4,fg="#fff",bg="#30336b")
label_date.config(font=("Arial Rounded MT Bold",15))
label_date.grid(row=1,column=0)
label_month=Label(root,text="BIRTH MONTH : ",borderwidth=5,fg="#fff",bg="#30336b")
label_month.config(font=("Arial Rounded MT Bold",15))
label_month.grid(row=2,column=0)
label_year=Label(root,text="BIRTH YEAR : ",borderwidth=9,fg="#fff",bg="#30336b")
label_year.config(font=("Arial Rounded MT Bold",15))
label_year.grid(row=3,column=0)

python_label=Label(root,text=f"Project Developed By- Python_Coderz_ \nFollow On Insta To Get Latest Updates",borderwidth=9,fg="#6ab04c",bg="#30336b")
python_label.config(font=("Mangal",10, BOLD))
python_label.grid(row=5,column=0,columnspan=3)
