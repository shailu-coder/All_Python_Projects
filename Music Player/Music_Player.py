...
main_application.title('PC Music Player')
main_application.geometry('600x600')
main_application.wm_iconbitmap('PC Media Player.ico')

status_bar_label = ttk.Label(main_application, text = 'Welcome To Python_Coderz_ Music Player', relief = GROOVE, borderwidth = 2, font = ('Times New Roman', 15, 'italic'))
...
music_player_icon = PhotoImage(file = 'icon/PC Media Player Resized.png') # In About Us Section
...
def aboutus_func():
    ...
    text = ttk.Label(about_us_dialog, text = 'PC Music Player', font = ('Times New Roman', 28, 'bold'))
    text.pack(side = TOP)

    text1 = ttk.Label(about_us_dialog, text = 'An Indian Company', font = ('Times New Roman', 14))
    text1.pack(side = TOP)

    text2 = ttk.Label(about_us_dialog, text = 'PC - Python_Coderz_ \nmusic made by Shailendra Singh\n\nPC Music Player can read almost all music files and \nformats\n\nFor any queries contact at insta - \nhttps://www.instagram.com/python_coderz_/', font = ('Times New Roman', 12))
    text2.pack(side = TOP)
...
contactus = Menu(main_menu, tearoff = False)
...
help_menu.add_command(label ='Contact Us', image = about_us_icon, compound = LEFT, command = contact_func)
